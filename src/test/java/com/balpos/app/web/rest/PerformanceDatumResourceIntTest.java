...
public class PerformanceDatumResourceIntTest {
    ...
    public void setup() {
        ...
        final PerformanceDatumResource performanceDatumResource = new PerformanceDatumResource(performanceDatumService, performanceDatumQueryService, userResourceUtil);
